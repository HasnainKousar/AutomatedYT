...
VIDEO_HEIGHT     = 1080
VIDEO_FPS        = 24
CLIP_DURATION    = 5          # seconds per image clip
FADE_DURATION    = 0.5        # seconds for crossfade between clips

# --- Output Folders ---
OUTPUT_DIR       = "output"
AUDIO_DIR        = f"{OUTPUT_DIR}/audio"
IMAGES_DIR       = f"{OUTPUT_DIR}/images"       # you drop Meta AI images here
